var ChooseScene = function(game, stage)
{
  ...
  self.ready = function()
  {
    ...
    btn_game        = new ButtonBox(10,170,dc.width-20,30,function(evt){ game.start = 4; game.setScene(3); });
    btn_free        = new ButtonBox(10,210,dc.width-20,30,function(evt){ game.start = 5; game.setScene(3); });
